...
function featured_inner_custom_box($post) {
	...
	<div id="featured-metabox">
		<input type="checkbox" name="featured_post" value="1" id="featured_post_input" <?php if($featured) echo 'checked'; ?> /> <label for="featured_post_input"><?php _e('This post is featured', 'jeo'); ?></label>
	</div>
	<?php
}
